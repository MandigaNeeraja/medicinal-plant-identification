...
export default function GoogleSignInButton({ disabled = false }) {
  if (disabled) {
    return (
      <button
        ...
        title="Add GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET to .env"
      >
  ...
  return (
    <a href={getGoogleLoginUrl()} className="btn-secondary flex w-full items-center justify-center gap-3">
